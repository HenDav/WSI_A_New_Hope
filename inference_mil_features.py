...
parser.add_argument('-ex', '--experiment', type=int, default=324, help='Continue train of this experiment')
parser.add_argument('-fe', '--from_epoch', type=int, default=[150, 495], help='Use this epoch model for inference')
...
inf_loader = DataLoader(inf_dset, batch_size=1, shuffle=False, num_workers=cpu_available, pin_memory=True)
