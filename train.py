...
parser.add_argument('--train_dataset_size', default=30000, type=int)
parser.add_argument('--train_buffer_size', default=30000, type=int)
parser.add_argument('--train_max_size', default=10000, type=int)
parser.add_argument('--validation_dataset_size', default=2500, type=int)
parser.add_argument('--validation_buffer_size', default=2500, type=int)
parser.add_argument('--validation_max_size', default=10000, type=int)
