...
inference_files = {}
inference_files['model_1500-Tiles_500'] = 'Data from gipdeep/runs/TCGA-PR/214-fold 2/Inference/Model_Epoch_1500-Folds_[2]-Tiles_500.data'
inference_files['model_1480-Tiles_500'] = 'Data from gipdeep/runs/TCGA-PR/214-fold 2/Inference/Model_Epoch_1480-Folds_[2]-Tiles_500.data'
inference_files['model_1460-Tiles_500'] = 'Data from gipdeep/runs/TCGA-PR/214-fold 2/Inference/Model_Epoch_1460-Folds_[2]-Tiles_500.data'
inference_files['model_1440-Tiles_500'] = 'Data from gipdeep/runs/TCGA-PR/214-fold 2/Inference/Model_Epoch_1440-Folds_[2]-Tiles_500.data'
inference_files['model_1420-Tiles_500'] = 'Data from gipdeep/runs/TCGA-PR/214-fold 2/Inference/Model_Epoch_1420-Folds_[2]-Tiles_500.data'
'''
inference_files['50'] = 'runs/Exp_210-TestFold_4/Inference/Model_Epoch_1300-Folds_[4]-Tiles_50.data'
inference_files['80'] = 'runs/Exp_210-TestFold_4/Inference/Model_Epoch_1300-Folds_[4]-Tiles_80.data'
inference_files['150'] = 'runs/Exp_210-TestFold_4/Inference/Model_Epoch_1300-Folds_[4]-Tiles_150.data'
inference_files['200'] = 'runs/Exp_210-TestFold_4/Inference/Model_Epoch_1300-Folds_[4]-Tiles_200.data'
'''
'''
inference_files['1_50'] = 'Data from gipdeep/runs/91/Inference/Model_Epoch_4295-Folds_[1]-Tiles_50-EVAL_MODE.data'
inference_files['1_500'] = 'Data from gipdeep/runs/91/Inference/Model_Epoch_4295-Folds_[1]-Tiles_500-EVAL_MODE.data'
inference_files['2_50'] = 'Data from gipdeep/runs/91/Inference/Model_Epoch_4295-Folds_[2]-Tiles_50-EVAL_MODE.data'
inference_files['2_500'] = 'Data from gipdeep/runs/91/Inference/Model_Epoch_4295-Folds_[2]-Tiles_500-EVAL_MODE.data'
inference_files['2_2000'] = 'Data from gipdeep/runs/91/Inference/Model_Epoch_4295-Folds_[2]-Tiles_2000-EVAL_MODE.data'
inference_files['2_5000'] = 'Data from gipdeep/runs/91/Inference/Model_Epoch_4295-Folds_[2]-Tiles_5000-EVAL_MODE.data'
'''
infer_type = 'REG'
