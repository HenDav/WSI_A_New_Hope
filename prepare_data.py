...
parser.add_argument('--format', type=str, default='TCGA', help='format of data folder - TCGA/ABCTB')
...
if __name__ =='__main__':
    ...
    if args.segmentation:
        utils.make_segmentations(data_path=args.data_folder + '/', rewrite=True, data_format=args.format)
