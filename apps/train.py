...
def parse_args():
    ...
    parser.add_argument('--model-storage-rate', type=int, default=10)

    parser.add_argument('--feature-extractor-model-class', type=str)
    parser.add_argument('--classifier-model-class', type=str)
    parser.add_argument('--loss-function-class', type=str)
...
if __name__ == '__main__':
    ...
    args = parse_args()
    experiment = experiments.Experiment(args=args)
    experiment.run()
